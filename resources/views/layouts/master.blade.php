...
<html lang="en">
    ...
    <body>
        ...
        {{-- we removed the callback bit because we will use jquery instead --}}
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDeo8i1WBhS4WiDV2OQ5fTuHvKkGd_OWN4&libraries=places"
        async defer></script>
...
{{-- AIzaSyDeo8i1WBhS4WiDV2OQ5fTuHvKkGd_OWN4 --}}